...
public class HSniper extends javax.swing.JFrame {
Random n1 = new Random();
    ...
    public HSniper() {
        initComponents();
        setTitle("Random Loadout Sniper");
        setSize(806, 479);
        tirarImgs();
        randomizarRWOn();
        verificarPrimary();
    ...
    private void initComponents() {
        ...
        jlP1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/AWPer_Hand.png"))); // NOI18N
        getContentPane().add(jlP1);
        jlP1.setBounds(110, 110, 130, 60);

        jlP2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Bazaar_Bargain.png"))); // NOI18N
        getContentPane().add(jlP2);
        jlP2.setBounds(110, 110, 130, 60);

        jlP3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Classic.png"))); // NOI18N
        getContentPane().add(jlP3);
        jlP3.setBounds(110, 110, 130, 60);

        jlP4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Fortified_Compound.png"))); // NOI18N
        getContentPane().add(jlP4);
        jlP4.setBounds(110, 110, 130, 60);

        jlP5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Hitman's_Heatmaker.png"))); // NOI18N
        getContentPane().add(jlP5);
        jlP5.setBounds(110, 110, 130, 60);

        jlP6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Huntsman.png"))); // NOI18N
        getContentPane().add(jlP6);
        jlP6.setBounds(110, 110, 130, 60);

        jlP7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Machina.png"))); // NOI18N
        getContentPane().add(jlP7);
        jlP7.setBounds(110, 110, 130, 60);

        jlP8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Shooting_Star.png"))); // NOI18N
        getContentPane().add(jlP8);
        jlP8.setBounds(110, 110, 130, 60);

        jlP9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Sniper_Rifle.png"))); // NOI18N
        getContentPane().add(jlP9);
        jlP9.setBounds(110, 110, 130, 60);

        jlP10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Primary/Sydney_Sleeper.png"))); // NOI18N
        getContentPane().add(jlP10);
        jlP10.setBounds(110, 110, 130, 60);

        jlS1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Secondary/Cleaner's_Carbine.png"))); // NOI18N
        getContentPane().add(jlS1);
        jlS1.setBounds(110, 180, 130, 60);

        jlS2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Secondary/Cozy_Camper.png"))); // NOI18N
        getContentPane().add(jlS2);
        jlS2.setBounds(110, 180, 130, 60);

        jlS3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Secondary/Darwin's_Danger_Shield.png"))); // NOI18N
        getContentPane().add(jlS3);
        jlS3.setBounds(110, 180, 130, 60);

        jlS4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Secondary/Jarate.png"))); // NOI18N
        getContentPane().add(jlS4);
        jlS4.setBounds(110, 180, 130, 60);

        jlS5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Secondary/Razorback.png"))); // NOI18N
        getContentPane().add(jlS5);
        jlS5.setBounds(110, 180, 130, 60);

        jlS6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Secondary/SMG.png"))); // NOI18N
        getContentPane().add(jlS6);
        jlS6.setBounds(110, 180, 130, 60);

        jlS7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Secondary/Self-Aware_Beauty_Mark.png"))); // NOI18N
        ...
        jlM2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Melee/Bushwacka.png"))); // NOI18N
        getContentPane().add(jlM2);
        jlM2.setBounds(110, 250, 130, 60);

        jlM3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Conscientious_Objector.png"))); // NOI18N
        getContentPane().add(jlM3);
        jlM3.setBounds(110, 250, 130, 60);

        jlM4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Crossing_Guard.png"))); // NOI18N
        getContentPane().add(jlM4);
        jlM4.setBounds(110, 250, 130, 60);

        jlM5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Freedom_Staff.png"))); // NOI18N
        getContentPane().add(jlM5);
        jlM5.setBounds(110, 250, 130, 60);

        jlM6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Frying_Pan.png"))); // NOI18N
        getContentPane().add(jlM6);
        jlM6.setBounds(110, 250, 130, 60);

        jlM7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Golden_Frying_Pan.png"))); // NOI18N
        getContentPane().add(jlM7);
        jlM7.setBounds(110, 250, 130, 60);

        jlM8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Ham_Shank.png"))); // NOI18N
        getContentPane().add(jlM8);
        jlM8.setBounds(110, 250, 130, 60);

        jlM9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Melee/Kukri.png"))); // NOI18N
        ...
        jlM14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Melee/Shahanshah.png"))); // NOI18N
        getContentPane().add(jlM14);
        jlM14.setBounds(110, 250, 130, 60);

        jlM15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/08_Sniper/Melee/Tribalman's_Shiv.png"))); // NOI18N
        ...
        gif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Gifs/Sniper.gif"))); // NOI18N
        getContentPane().add(gif);
        gif.setBounds(430, 130, 300, 180);

        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/LoadoutsBG/Sniper.png"))); // NOI18N
    ...
    private void jbLinks1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbLinks1ActionPerformed
        try{
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(this.url1));
        }catch(Exception e){
    ...
    private void jbLinks2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbLinks2ActionPerformed
        try{
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(this.url2));
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
    ...
    private void jbLinks3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbLinks3ActionPerformed
        try{
            java.awt.Desktop.getDesktop().browse(java.net.URI.create(this.url3));
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HSniper.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel jlP10;
    ...
    private void randomizarRWOff() {
        do{
            ...
            secon = n1.nextInt(8);
            mel = n1.nextInt(16);
        }while(prim==0 || prim>10 || secon==0 || secon>7 || mel==0 || mel==10 || mel==13 || mel>15); 
    ...
    private void randomizarRWOn() {
        do{
            ...
            secon = n1.nextInt(8);
            mel = n1.nextInt(16);
        }while(prim==0 || prim>10 || secon==0 || secon>7 || mel==0 || mel>15); 
    ...
    private void verificarPrimary() {
        switch(prim){
                case 1:
                        ...
                        url1="https://wiki.teamfortress.com/wiki/AWPer_Hand";
                    break;
                case 2:
                        jlP2.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Bazaar_Bargain";
                    break;
                case 3:
                        jlP3.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Classic";
                    break;
                case 4:
                        jlP4.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Fortified_Compound";
                    break;
                case 5:
                        jlP5.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Hitman%27s_Heatmaker";
                    break;
                case 6:
                        jlP6.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Huntsman";
                    break;
                case 7:
                        jlP7.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Machina";
                    break;
                case 8:
                        jlP8.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Shooting_Star";
                    break;
                case 9:
                        jlP9.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Sniper_Rifle";
                    break;
                case 10:
                        jlP10.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Sydney_Sleeper";
                    break;
                default:
                    break;
        }
    ...
    private void verificarSecondary() {
        switch(secon){
                case 1:
                        ...
                        url2="https://wiki.teamfortress.com/wiki/Cleaner%27s_Carbine";
                    break;
                case 2:
                        jlS2.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Cozy_Camper";
                    break;
                case 3:
                        jlS3.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Darwin%27s_Danger_Shield";
                    break;
                case 4:
                        jlS4.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Jarate";
                    break;
                case 5:
                        jlS5.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Razorback";
                    break;
                case 6:
                        jlS6.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Submachine_Gun";
                    break;
                case 7:
                        jlS7.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Self-Aware_Beauty_Mark";
                    break;
                default:
                    break;
        }
    ...
    private void verificarMelee() {
        switch(mel){
                ...
                case 2:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Bushwacka";
                    break;
                case 3:
                ...
                case 9:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Kukri";
                    break;
                case 10:
                ...
                case 14:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Shahanshah";
                    break;
                case 15:
                        jlM15.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Tribalman%27s_Shiv";
                    break;
                default:
                    break;
        }
    ...
    private void setIcon() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("icons/HSniper.png")));
    }

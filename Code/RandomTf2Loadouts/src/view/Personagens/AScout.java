...
public class AScout extends javax.swing.JFrame {
Random n1 = new Random();
    ...
    private void initComponents() {
        ...
        jlS8 = new javax.swing.JLabel();
        jlS9 = new javax.swing.JLabel();
        jlS10 = new javax.swing.JLabel();
        ...
        jlP1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Primary/Baby_Face's_Blaster.png"))); // NOI18N
        getContentPane().add(jlP1);
        jlP1.setBounds(110, 110, 130, 60);

        jlP2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Primary/Back_Scatter.png"))); // NOI18N
        getContentPane().add(jlP2);
        jlP2.setBounds(110, 110, 130, 60);

        jlP3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Primary/Force-A-Nature.png"))); // NOI18N
        getContentPane().add(jlP3);
        jlP3.setBounds(110, 110, 130, 60);

        jlP4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Primary/Scattergun.png"))); // NOI18N
        getContentPane().add(jlP4);
        jlP4.setBounds(110, 110, 130, 60);

        jlP5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Primary/Shortstop.png"))); // NOI18N
        getContentPane().add(jlP5);
        jlP5.setBounds(110, 110, 130, 60);

        jlP6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Primary/Soda_Popper.png"))); // NOI18N
        getContentPane().add(jlP6);
        jlP6.setBounds(110, 110, 130, 60);

        jlS1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Secondary/Bonk!_Atomic_Punch.png"))); // NOI18N
        getContentPane().add(jlS1);
        jlS1.setBounds(110, 180, 130, 60);

        jlS2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Secondary/C.A.P.P.E.R.png"))); // NOI18N
        getContentPane().add(jlS2);
        jlS2.setBounds(110, 180, 130, 60);

        jlS3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Secondary/Crit-a-Cola.png"))); // NOI18N
        getContentPane().add(jlS3);
        jlS3.setBounds(110, 180, 130, 60);

        jlS4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Secondary/Flying_Guillotine.png"))); // NOI18N
        getContentPane().add(jlS4);
        jlS4.setBounds(110, 180, 130, 60);

        jlS5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Secondary/Lugermorph.png"))); // NOI18N
        getContentPane().add(jlS5);
        jlS5.setBounds(110, 180, 130, 60);

        jlS6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Secondary/Mad_Milk.png"))); // NOI18N
        getContentPane().add(jlS6);
        jlS6.setBounds(110, 180, 130, 60);

        jlS7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Secondary/Mutated_Milk.png"))); // NOI18N
        getContentPane().add(jlS7);
        jlS7.setBounds(110, 180, 130, 60);

        jlS8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Secondary/Pistol.png"))); // NOI18N
        getContentPane().add(jlS8);
        jlS8.setBounds(110, 180, 130, 60);

        jlS9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Secondary/Pretty_Boy's_Pocket_Pistol.png"))); // NOI18N
        getContentPane().add(jlS9);
        jlS9.setBounds(110, 180, 130, 60);

        jlS10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Secondary/Winger.png"))); // NOI18N
        getContentPane().add(jlS10);
        jlS10.setBounds(110, 180, 130, 60);

        jlM1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Atomizer.png"))); // NOI18N
        getContentPane().add(jlM1);
        jlM1.setBounds(110, 250, 130, 60);

        jlM2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Bat.png"))); // NOI18N
        ...
        jlM4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Batsaber.png"))); // NOI18N
        getContentPane().add(jlM4);
        jlM4.setBounds(110, 250, 130, 60);

        jlM5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Boston_Basher.png"))); // NOI18N
        getContentPane().add(jlM5);
        jlM5.setBounds(110, 250, 130, 60);

        jlM6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Candy_Cane.png"))); // NOI18N
        getContentPane().add(jlM6);
        jlM6.setBounds(110, 250, 130, 60);

        jlM7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Conscientious_Objector.png"))); // NOI18N
        getContentPane().add(jlM7);
        jlM7.setBounds(110, 250, 130, 60);

        jlM8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Crossing_Guard.png"))); // NOI18N
        getContentPane().add(jlM8);
        jlM8.setBounds(110, 250, 130, 60);

        jlM9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Fan_O'War.png"))); // NOI18N
        getContentPane().add(jlM9);
        jlM9.setBounds(110, 250, 130, 60);

        jlM10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Freedom_Staff.png"))); // NOI18N
        getContentPane().add(jlM10);
        jlM10.setBounds(110, 250, 130, 60);

        jlM11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Frying_Pan.png"))); // NOI18N
        getContentPane().add(jlM11);
        jlM11.setBounds(110, 250, 130, 60);

        jlM12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Golden_Frying_Pan.png"))); // NOI18N
        getContentPane().add(jlM12);
        jlM12.setBounds(110, 250, 130, 60);

        jlM13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Ham_Shank.png"))); // NOI18N
        getContentPane().add(jlM13);
        jlM13.setBounds(110, 250, 130, 60);

        jlM14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Holy_Mackerel.png"))); // NOI18N
        getContentPane().add(jlM14);
        jlM14.setBounds(110, 250, 130, 60);

        jlM15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Memory_Maker.png"))); // NOI18N
        getContentPane().add(jlM15);
        jlM15.setBounds(110, 250, 130, 60);

        jlM16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Necro_Smasher.png"))); // NOI18N
        getContentPane().add(jlM16);
        jlM16.setBounds(110, 250, 130, 60);

        jlM17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Prinny_Machete.png"))); // NOI18N
        getContentPane().add(jlM17);
        jlM17.setBounds(110, 250, 130, 60);

        jlM18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Sandman.png"))); // NOI18N
        ...
        jlM20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Sun-on-a-Stick.png"))); // NOI18N
        getContentPane().add(jlM20);
        jlM20.setBounds(110, 250, 130, 60);

        jlM21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Three-Rune_Blade.png"))); // NOI18N
        getContentPane().add(jlM21);
        jlM21.setBounds(110, 250, 130, 60);

        jlM22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Unarmed_Combat.png"))); // NOI18N
        getContentPane().add(jlM22);
        jlM22.setBounds(110, 250, 130, 60);

        jlM23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/01_Scout/Melee/Wrap_Assassin.png"))); // NOI18N
        getContentPane().add(jlM23);
        jlM23.setBounds(110, 250, 130, 60);
        ...
        gif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Gifs/Scout.gif"))); // NOI18N
        getContentPane().add(gif);
        gif.setBounds(350, 100, 380, 280);

        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/LoadoutsBG/Scout.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AScout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel jlM23;
    ...
    private javax.swing.JLabel jlS10;
    ...
    private javax.swing.JLabel jlS8;
    private javax.swing.JLabel jlS9;
    ...
    private void tirarImgs() {
        ...
        jlS8.setVisible(false);
        jlS9.setVisible(false);
        jlS10.setVisible(false);
        ...
        jlM23.setVisible(false);
        
    }

    //Randomiza as armas, porém, com as armas raras desabilitadas
    private void randomizarRWOff() {
        do{
            prim = n1.nextInt(7);
            secon = n1.nextInt(11);
            mel = n1.nextInt(24);
        }while(prim==0 || prim>6 || secon==0 || secon>10 || mel==0 || mel==15 || mel==19 || mel>23);  
    }
    
    //Randomiza as armas de maneira normal
    private void randomizarRWOn() {
        do{
            prim = n1.nextInt(7);
            secon = n1.nextInt(11);
            mel = n1.nextInt(24);
        }while(prim==0 || prim>6 || secon==0 || secon>10 || mel==0 || mel>23);
    }
    ...
    private void verificarPrimary() {
        switch(prim){
                case 1:
                        ...
                        url1="https://wiki.teamfortress.com/wiki/Baby_Face%27s_Blaster";
                    break;
                case 2:
                        jlP2.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Back_Scatter";
                    break;
                case 3:
                        jlP3.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Force-A-Nature";
                    break;
                case 4:
                        jlP4.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Scattergun";
                    break;
                case 5:
                        jlP5.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Shortstop";
                    break;
                case 6:
                        jlP6.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Soda_Popper";
                    break;
                default:
                    break;
        }
    ...
    private void verificarSecondary() {
        switch(secon){
                case 1:
                        ...
                        url2="https://wiki.teamfortress.com/wiki/Bonk!_Atomic_Punch";
                    break;
                case 2:
                ...
                case 3:
                        ...
                        url2="https://wiki.teamfortress.com/wiki/Crit-a-Cola";
                    break;
                case 4:
                        jlS4.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Flying_Guillotine";
                    break;
                case 5:
                ...
                case 6:
                        ...
                        url2="https://wiki.teamfortress.com/wiki/Mad_Milk";
                    break;
                case 7:
                        jlS7.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Mutated_Milk";
                    break;
                case 8:
                        jlS8.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Pistol";
                    break;
                case 9:
                        jlS9.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Pretty_Boy%27s_Pocket_Pistol";
                    break;
                case 10:
                        jlS10.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Winger";
                    break;
                default:
                    break;
        }
    ...
    private void verificarMelee() {
        switch(mel){
                case 1:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Atomizer";
                    break;
                case 2:
                        jlM2.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Bat";
                    break;
                case 3:
                ...
                case 4:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Batsaber";
                    break;
                case 5:
                        jlM5.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Boston_Basher";
                    break;
                case 6:
                        jlM6.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Candy_Cane";
                    break;
                case 7:
                ...
                case 9:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Fan_O%27War";
                    break;
                case 10:
                ...
                case 14:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Holy_Mackerel";
                    break;
                case 15:
                ...
                case 18:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Sandman";
                    break;
                case 19:
                ...
                case 20:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Sun-on-a-Stick";
                    break;
                case 21:
                        jlM21.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Three-Rune_Blade";
                    break;
                case 22:
                        jlM22.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Unarmed_Combat";
                    break;
                case 23:
                        jlM23.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Wrap_Assassin";
                    break;
                default:
                    break;
        }
    ...
    private void setIcon() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("icons/AScout.png")));
    }

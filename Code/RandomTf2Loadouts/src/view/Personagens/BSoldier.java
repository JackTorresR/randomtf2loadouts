...
public class BSoldier extends javax.swing.JFrame {
Random n1 = new Random();
    ...
    public BSoldier() {
        initComponents();
        setTitle("Random Loadout Soldier");
        setSize(806, 479);
        tirarImgs();
        randomizarRWOn();
        verificarPrimary();
    ...
    private void initComponents() {
        ...
        jlP1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Air_Strike.png"))); // NOI18N
        getContentPane().add(jlP1);
        jlP1.setBounds(110, 110, 130, 60);

        jlP2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Beggar's_Bazooka.png"))); // NOI18N
        getContentPane().add(jlP2);
        jlP2.setBounds(110, 110, 130, 60);

        jlP3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Black_Box.png"))); // NOI18N
        getContentPane().add(jlP3);
        jlP3.setBounds(110, 110, 130, 60);

        jlP4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Cow_Mangler_5000.png"))); // NOI18N
        getContentPane().add(jlP4);
        jlP4.setBounds(110, 110, 130, 60);

        jlP5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Direct_Hit.png"))); // NOI18N
        getContentPane().add(jlP5);
        jlP5.setBounds(110, 110, 130, 60);

        jlP6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Liberty_Launcher.png"))); // NOI18N
        getContentPane().add(jlP6);
        jlP6.setBounds(110, 110, 130, 60);

        jlP7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Original.png"))); // NOI18N
        getContentPane().add(jlP7);
        jlP7.setBounds(110, 110, 130, 60);

        jlP8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Rocket_Jumper.png"))); // NOI18N
        getContentPane().add(jlP8);
        jlP8.setBounds(110, 110, 130, 60);

        jlP9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Primary/Rocket_Launcher.png"))); // NOI18N
        getContentPane().add(jlP9);
        jlP9.setBounds(110, 110, 130, 60);

        jlS1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/B.A.S.E._Jumper.png"))); // NOI18N
        getContentPane().add(jlS1);
        jlS1.setBounds(110, 180, 130, 60);

        jlS2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Secondary/Battalion's_Backup.png"))); // NOI18N
        getContentPane().add(jlS2);
        jlS2.setBounds(110, 180, 130, 60);

        jlS3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Secondary/Buff_Banner.png"))); // NOI18N
        getContentPane().add(jlS3);
        jlS3.setBounds(110, 180, 130, 60);

        jlS4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Secondary/Concheror.png"))); // NOI18N
        getContentPane().add(jlS4);
        jlS4.setBounds(110, 180, 130, 60);

        jlS5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Secondary/Gunboats.png"))); // NOI18N
        getContentPane().add(jlS5);
        jlS5.setBounds(110, 180, 130, 60);

        jlS6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Secondary/Mantreads.png"))); // NOI18N
        getContentPane().add(jlS6);
        jlS6.setBounds(110, 180, 130, 60);

        jlS7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Primary/Panic_Attack.png"))); // NOI18N
        getContentPane().add(jlS7);
        jlS7.setBounds(110, 180, 130, 60);

        jlS8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Secondary/Reserve_Shooter.png"))); // NOI18N
        getContentPane().add(jlS8);
        jlS8.setBounds(110, 180, 130, 60);

        jlS9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Secondary/Righteous_Bison.png"))); // NOI18N
        getContentPane().add(jlS9);
        jlS9.setBounds(110, 180, 130, 60);

        jlS10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Primary/Shotgun.png"))); // NOI18N
        ...
        jlM2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Conscientious_Objector.png"))); // NOI18N
        getContentPane().add(jlM2);
        jlM2.setBounds(110, 250, 130, 60);

        jlM3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Crossing_Guard.png"))); // NOI18N
        getContentPane().add(jlM3);
        jlM3.setBounds(110, 250, 130, 60);

        jlM4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Melee/Disciplinary_Action.png"))); // NOI18N
        getContentPane().add(jlM4);
        jlM4.setBounds(110, 250, 130, 60);

        jlM5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Melee/Equalizer.png"))); // NOI18N
        getContentPane().add(jlM5);
        jlM5.setBounds(110, 250, 130, 60);

        jlM6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Melee/Escape_Plan.png"))); // NOI18N
        ...
        jlM12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Melee/Market_Gardener.png"))); // NOI18N
        ...
        jlM15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Pain_Train.png"))); // NOI18N
        getContentPane().add(jlM15);
        jlM15.setBounds(110, 250, 130, 60);

        jlM16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Prinny_Machete.png"))); // NOI18N
        getContentPane().add(jlM16);
        jlM16.setBounds(110, 250, 130, 60);

        jlM17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Saxxy.png"))); // NOI18N
        getContentPane().add(jlM17);
        jlM17.setBounds(110, 250, 130, 60);

        jlM18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/02_Soldier/Melee/Shovel.png"))); // NOI18N
        getContentPane().add(jlM18);
        jlM18.setBounds(110, 250, 130, 60);

        gif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Gifs/Soldier.gif"))); // NOI18N
        getContentPane().add(gif);
        gif.setBounds(380, 100, 360, 280);
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/LoadoutsBG/Soldier.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BSoldier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void tirarImgs() {
        ...
        jlP8.setVisible(false);
        jlP9.setVisible(false);
    ...
    private void randomizarRWOff() {
        do{
            ...
            secon = n1.nextInt(10);
            mel = n1.nextInt(18);
        }while(prim==0 || prim>10 || secon==0 || secon>11 || mel==0 || mel==13 || mel==17 || mel>19);  
    }
    ...
    private void randomizarRWOn() {
        do{
            ...
            secon = n1.nextInt(10);
            mel = n1.nextInt(18);
        }while(prim==0 || prim>10 || secon==0 || secon>11 || mel==0 || mel>19);
    }
    ...
    private void verificarPrimary() {
        switch(prim){
                case 1:
                        ...
                        url1="https://wiki.teamfortress.com/wiki/Air_Strike";
                    break;
                case 2:
                        jlP2.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Beggar%27s_Bazooka";
                    break;
                case 3:
                        jlP3.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Black_Box";
                    break;
                case 4:
                        jlP4.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Cow_Mangler_5000";
                    break;
                case 5:
                        jlP5.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Direct_Hit";
                    break;
                case 6:
                        jlP6.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Liberty_Launcher";
                    break;
                case 7:
                        jlP7.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Original";
                    break;
                case 8:
                        jlP8.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Rocket_Jumper";
                    break;
                case 9:
                        jlP9.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Rocket_Launcher";
                    break;
                default:
                    break;
        }
    ...
    private void verificarSecondary() {
        switch(secon){
                case 1:
                        ...
                        url2="";https://wiki.teamfortress.com/wiki/B.A.S.E._Jumper
                    break;
                case 2:
                        jlS2.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Battalion%27s_Backup";
                    break;
                case 3:
                        jlS3.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Buff_Banner";
                    break;
                case 4:
                        jlS4.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Concheror";
                    break;
                case 5:
                        jlS5.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Mantreads";
                    break;
                case 6:
                        jlS6.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Gunboats";
                    break;
                case 7:
                ...
                case 9:
                        ...
                        url2="https://wiki.teamfortress.com/wiki/Righteous_Bison";
                    break;
                case 10:
    ...
    private void verificarMelee() {
        switch(mel){
                ...
                case 4:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Disciplinary_Action";
                    break;
                case 5:
                        jlM5.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Equalizer";
                    break;
                case 6:
                        jlM6.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Escape_Plan";
                    break;
                case 7:
                ...
                case 12:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Market_Gardener";
                    break;
                case 13:
                ...
                case 18:
                       ...
                       url3="https://wiki.teamfortress.com/wiki/Shovel";
                    break;
                default:
                    break;
        }
    ...
    private void setIcon() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("icons/BSoldier.png")));
    }

...
public class EHeavy extends javax.swing.JFrame {
Random n1 = new Random();
    ...
    private void initComponents() {
        ...
        jlP1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Primary/Brass_Beast.png"))); // NOI18N
        getContentPane().add(jlP1);
        jlP1.setBounds(110, 110, 130, 60);

        jlP2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Primary/Huo-Long_Heater.png"))); // NOI18N
        getContentPane().add(jlP2);
        jlP2.setBounds(110, 110, 130, 60);

        jlP3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Primary/Iron_Curtain.png"))); // NOI18N
        getContentPane().add(jlP3);
        jlP3.setBounds(110, 110, 130, 60);

        jlP4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Primary/Minigun.png"))); // NOI18N
        getContentPane().add(jlP4);
        jlP4.setBounds(110, 110, 130, 60);

        jlP5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Primary/Natascha.png"))); // NOI18N
        getContentPane().add(jlP5);
        jlP5.setBounds(110, 110, 130, 60);

        jlP6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Primary/Tomislav.png"))); // NOI18N
        getContentPane().add(jlP6);
        jlP6.setBounds(110, 110, 130, 60);

        jlS1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Secondary/Buffalo_Steak_Sandvich.png"))); // NOI18N
        getContentPane().add(jlS1);
        jlS1.setBounds(110, 180, 130, 60);

        jlS2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Secondary/Dalokohs_Bar.png"))); // NOI18N
        getContentPane().add(jlS2);
        jlS2.setBounds(110, 180, 130, 60);

        jlS3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Secondary/Family_Business.png"))); // NOI18N
        getContentPane().add(jlS3);
        jlS3.setBounds(110, 180, 130, 60);

        jlS4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Secondary/Fishcake.png"))); // NOI18N
        getContentPane().add(jlS4);
        jlS4.setBounds(110, 180, 130, 60);

        jlS5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Primary/Panic_Attack.png"))); // NOI18N
        getContentPane().add(jlS5);
        jlS5.setBounds(110, 180, 130, 60);

        jlS6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Secondary/Robo-Sandvich.png"))); // NOI18N
        getContentPane().add(jlS6);
        jlS6.setBounds(110, 180, 130, 60);

        jlS7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Secondary/Sandvich.png"))); // NOI18N
        getContentPane().add(jlS7);
        jlS7.setBounds(110, 180, 130, 60);

        jlS8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Primary/Shotgun.png"))); // NOI18N
        getContentPane().add(jlS8);
        jlS8.setBounds(110, 180, 130, 60);

        jlM1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Apoco-Fists.png"))); // NOI18N
        ...
        jlM3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Bread_Bite.png"))); // NOI18N
        ...
        jlM6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Eviction_Notice.png"))); // NOI18N
        getContentPane().add(jlM6);
        jlM6.setBounds(110, 250, 130, 60);

        jlM7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Fists.png"))); // NOI18N
        getContentPane().add(jlM7);
        jlM7.setBounds(110, 250, 130, 60);

        jlM8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Fists_of_Steel.png"))); // NOI18N
        getContentPane().add(jlM8);
        jlM8.setBounds(110, 250, 130, 60);

        jlM9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Freedom_Staff.png"))); // NOI18N
        getContentPane().add(jlM9);
        jlM9.setBounds(110, 250, 130, 60);

        jlM10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Frying_Pan.png"))); // NOI18N
        getContentPane().add(jlM10);
        jlM10.setBounds(110, 250, 130, 60);

        jlM11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Gloves_of_Running_Urgently.png"))); // NOI18N
        ...
        jlM14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Holiday_Punch.png"))); // NOI18N
        getContentPane().add(jlM14);
        jlM14.setBounds(110, 250, 130, 60);

        jlM15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Killing_Gloves_of_Boxing.png"))); // NOI18N
        getContentPane().add(jlM15);
        jlM15.setBounds(110, 250, 130, 60);

        jlM16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Memory_Maker.png"))); // NOI18N
        getContentPane().add(jlM16);
        jlM16.setBounds(110, 250, 130, 60);

        jlM17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/10_Multi Classes/Melee/Necro_Smasher.png"))); // NOI18N
        ...
        jlM20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/IMG/Armas tf2/05_Heavy/Melee/Warrior's_Spirit.png"))); // NOI18N
        ...
        gif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Gifs/Heavy.gif"))); // NOI18N
        getContentPane().add(gif);
        gif.setBounds(370, 100, 390, 280);

        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/LoadoutsBG/Heavy.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EHeavy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void randomizarRWOff() {
        do{
            ...
            secon = n1.nextInt(9);
            mel = n1.nextInt(21);
        }while(prim==0 || prim>6 || secon==0 || secon>8 || mel==0 || mel==16 || mel==19 || mel>20); 
    }
    ...
    private void randomizarRWOn() {
        do{
            ...
            secon = n1.nextInt(9);
            mel = n1.nextInt(21);
        }while(prim==0 || prim>6 || secon==0 || secon>8 || mel==0 || mel>20); 
    }
    ...
    private void verificarPrimary() {
        switch(prim){
                case 1:
                        ...
                        url1="https://wiki.teamfortress.com/wiki/Brass_Beast";
                    break;
                case 2:
                        jlP2.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Huo-Long_Heater";
                    break;
                case 3:
                        jlP3.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Iron_Curtain";
                    break;
                case 4:
                        jlP4.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Minigun";
                    break;
                case 5:
                        jlP5.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Natascha";
                    break;
                case 6:
                        jlP6.setVisible(true);
                        url1="https://wiki.teamfortress.com/wiki/Tomislav";
                    break;
                default:
                    break;
        }
    ...
    private void verificarSecondary() {
        switch(secon){
                case 1:
                        ...
                        url2="https://wiki.teamfortress.com/wiki/Buffalo_Steak_Sandvich";
                    break;
                case 2:
                        jlS2.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Dalokohs_Bar";
                    break;
                case 3:
                        jlS3.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Family_Business";
                    break;
                case 4:
                        jlS4.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Fishcake";
                    break;
                case 5:
                ...
                case 6:
                        ...
                        url2="https://wiki.teamfortress.com/wiki/Robo-Sandvich";
                    break;
                case 7:
                        jlS7.setVisible(true);
                        url2="https://wiki.teamfortress.com/wiki/Sandvich";
                    break;
                case 8:
    ...
    private void verificarMelee() {
        switch(mel){
                case 1:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Apoco-Fists";
                    break;
                case 2:
                ...
                case 3:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Bread_Bite";
                    break;
                case 4:
                ...
                case 6:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Eviction_Notice";
                    break;
                case 7:
                        jlM7.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Fists";
                    break;
                case 8:
                        jlM8.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Fists_of_Steel";
                    break;
                case 9:
                ...
                case 11:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Gloves_of_Running_Urgently";
                    break;
                case 12:
                ...
                case 14:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Holiday_Punch";
                    break;
                case 15:
                        jlM15.setVisible(true);
                        url3="https://wiki.teamfortress.com/wiki/Killing_Gloves_of_Boxing";
                    break;
                case 16:
                ...
                case 20:
                        ...
                        url3="https://wiki.teamfortress.com/wiki/Warrior%27s_Spirit";
                    break;
                default:
                    break;
        }
    ...
    private void setIcon() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("icons/EHeavy.png")));
    }
